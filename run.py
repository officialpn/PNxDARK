...
DEFAULT_PRICING = {
    ...
    "plans": [
        {"name": "Starter", "duration": "24 Hours",  "price": "29",  "features": "1 file run, 512MB RAM, Real-time logs"},
        {"name": "Basic",   "duration": "7 Days",    "price": "199", "features": "Multi-file upload, pip/npm install, 24/7 uptime"},
        {"name": "Pro",     "duration": "30 Days",   "price": "299", "features": "Unlimited modules, Priority support, Auto-restart"},
        {"name": "Premium", "duration": "Lifetime",  "price": "999","features": "All features, Custom domain, Dedicated help"},
    ],
}
